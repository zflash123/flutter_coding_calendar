...
class _AddNewTaskState extends State<AddNewTask> {
  ...
  var projectName, dateEvent, startTime, finishTime;
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: (dateEventValue) {
                            if (dateEventValue!.isEmpty) {
  ...
  void createTask() async {
    var data = {
      ...
      'start_time_plan': startTime,
      'finish_time_plan': finishTime,
    };
    var res = await Network().createEvent(data, 'user/create_event');
